...
class BrickletVoltage extends Device
{
     ...
     * sensor.
     * 
     * The BrickletVoltage::CALLBACK_VOLTAGE callback is only triggered if the voltage has changed since
     * the last triggering.
     */
    ...
    /**
     * This callback is triggered periodically with the period that is set by
     * BrickletVoltage::setAnalogValueCallbackPeriod(). The parameter is the
     * analog value of the sensor.
     * 
     * The BrickletVoltage::CALLBACK_ANALOG_VALUE callback is only triggered if the voltage has changed
    ...
    const DEVICE_DISPLAY_NAME = 'Voltage Bricklet';
     ...
     * BrickletVoltage::CALLBACK_VOLTAGE callback and set the period with
     ...
     * BrickletVoltage::CALLBACK_ANALOG_VALUE callback and set the period with
    ...
    /**
     * Sets the period with which the BrickletVoltage::CALLBACK_VOLTAGE callback is triggered
    ...
    /**
     * Sets the period with which the BrickletVoltage::CALLBACK_ANALOG_VALUE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * The BrickletVoltage::CALLBACK_ANALOG_VALUE callback is only triggered if the analog value has
