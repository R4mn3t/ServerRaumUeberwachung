 ...
 */
class BrickletLoadCellV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletLoadCellV2::setWeightCallbackConfiguration().
     * 
     * The parameter is the same as BrickletLoadCellV2::getWeight().
     */
    const CALLBACK_WEIGHT = 4;
     ...
     * @internal
     */
    const FUNCTION_SET_WEIGHT_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_WEIGHT_CALLBACK_CONFIGURATION = 3;

    /**
     * @internal
     */
    const FUNCTION_SET_MOVING_AVERAGE = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_MOVING_AVERAGE = 6;

    /**
     * @internal
     */
    const FUNCTION_SET_INFO_LED_CONFIG = 7;

    /**
     * @internal
     */
    const FUNCTION_GET_INFO_LED_CONFIG = 8;

    /**
     * @internal
     */
    const FUNCTION_CALIBRATE = 9;

    /**
     * @internal
     */
    const FUNCTION_TARE = 10;
    ...
    const DEVICE_IDENTIFIER = 2104;

    const DEVICE_DISPLAY_NAME = 'Load Cell Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_WEIGHT_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_WEIGHT_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
     ...
     * BrickletLoadCellV2::CALLBACK_WEIGHT callback. You can set the callback configuration
     * with BrickletLoadCellV2::setWeightCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletLoadCellV2::CALLBACK_WEIGHT callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletLoadCellV2::CALLBACK_WEIGHT callback.
     * 
     ...
     * @return void
     */
    public function setWeightCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_WEIGHT_CALLBACK_CONFIGURATION, $payload, 0);
    }

    /**
     * Returns the callback configuration as set by BrickletLoadCellV2::setWeightCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getWeightCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_WEIGHT_CALLBACK_CONFIGURATION, $payload, 22);
    ...
    public function setMovingAverage($average)
    {
        ...
        $payload = '';
        $payload .= pack('v', $average);

        $this->sendRequest(self::FUNCTION_SET_MOVING_AVERAGE, $payload, 0);
    }

    /**
     * Returns the length moving average as set by BrickletLoadCellV2::setMovingAverage().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Returns the LED configuration as set by BrickletLoadCellV2::setInfoLEDConfig()
     * 
     * 
     * @return int
     */
     ...
     * (see BrickletLoadCellV2::setMovingAverage()) to the measurements.
     * 
    ...
    /**
     * Returns the configuration as set by BrickletLoadCellV2::setConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the current bootloader mode, see BrickletLoadCellV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletLoadCellV2::writeFirmware(). The pointer has
     ...
     * BrickletLoadCellV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletLoadCellV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
