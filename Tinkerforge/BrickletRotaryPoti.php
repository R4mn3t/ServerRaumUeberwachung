...
class BrickletRotaryPoti extends Device
{
     ...
     * BrickletRotaryPoti::setPositionCallbackPeriod(). The parameter is the position of
     * the rotary potentiometer.
     * 
     * The BrickletRotaryPoti::CALLBACK_POSITION callback is only triggered if the position has changed since
     * the last triggering.
     */
    ...
    /**
     * This callback is triggered periodically with the period that is set by
     * BrickletRotaryPoti::setAnalogValueCallbackPeriod(). The parameter is the
     * analog value of the rotary potentiometer.
     * 
     * The BrickletRotaryPoti::CALLBACK_ANALOG_VALUE callback is only triggered if the position has changed
    ...
    const DEVICE_DISPLAY_NAME = 'Rotary Poti Bricklet';
     ...
     * BrickletRotaryPoti::CALLBACK_POSITION callback and set the period with
     ...
     * BrickletRotaryPoti::CALLBACK_ANALOG_VALUE callback and set the period with
    ...
    /**
     * Sets the period with which the BrickletRotaryPoti::CALLBACK_POSITION callback is triggered
    ...
    /**
     * Sets the period with which the BrickletRotaryPoti::CALLBACK_ANALOG_VALUE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * The BrickletRotaryPoti::CALLBACK_ANALOG_VALUE callback is only triggered if the analog value has
