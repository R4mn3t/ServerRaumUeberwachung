 ...
 */
class BrickletIndustrialDualACRelay extends Device
{
     ...
     */
    const CALLBACK_MONOFLOP_DONE = 7;
     ...
     * @internal
     */
    const FUNCTION_SET_CHANNEL_LED_CONFIG = 3;

    /**
     * @internal
     */
    const FUNCTION_GET_CHANNEL_LED_CONFIG = 4;

    /**
     * @internal
     */
    const FUNCTION_SET_MONOFLOP = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_MONOFLOP = 6;

    /**
     * @internal
     */
    const FUNCTION_SET_SELECTED_VALUE = 8;
    ...
    const DEVICE_IDENTIFIER = 2162;

    const DEVICE_DISPLAY_NAME = 'Industrial Dual AC Relay Bricklet';
     ...
     * of the other relay, you can get the state with BrickletIndustrialDualACRelay::getValue() or you
     * can use BrickletIndustrialDualACRelay::setSelectedValue().
     * 
    ...
    /**
     * Returns the channel LED configuration as set by BrickletIndustrialDualACRelay::setChannelLEDConfig()
     * 
     * @param int $channel
     * 
     * @return int
     ...
     * BrickletIndustrialDualACRelay::setMonoflop() as well as the remaining time until the state flips.
     * 
    ...
    /**
     * Returns the current bootloader mode, see BrickletIndustrialDualACRelay::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletIndustrialDualACRelay::writeFirmware(). The pointer has
     ...
     * BrickletIndustrialDualACRelay::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletIndustrialDualACRelay::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
