...
class BrickletTemperature extends Device
{
     ...
     * BrickletTemperature::setTemperatureCallbackPeriod(). The parameter is the
     * temperature of the sensor.
     * 
     * The BrickletTemperature::CALLBACK_TEMPERATURE callback is only triggered if the temperature has changed
    ...
    const DEVICE_DISPLAY_NAME = 'Temperature Bricklet';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->callback_wrappers[self::CALLBACK_TEMPERATURE_REACHED] = array(10, 'callbackWrapperTemperatureReached');
     ...
     * to use the BrickletTemperature::CALLBACK_TEMPERATURE callback and set the period with
    ...
    /**
     * Sets the period with which the BrickletTemperature::CALLBACK_TEMPERATURE callback is triggered
    ...
    public function getTemperatureCallbackThreshold()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_TEMPERATURE_CALLBACK_THRESHOLD, $payload, 13);
