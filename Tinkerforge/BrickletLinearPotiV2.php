 ...
 */
class BrickletLinearPotiV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletLinearPotiV2::setPositionCallbackConfiguration().
     * 
     * The parameter is the same as BrickletLinearPotiV2::getPosition().
     */
    ...
    const DEVICE_IDENTIFIER = 2139;

    const DEVICE_DISPLAY_NAME = 'Linear Poti Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->callback_wrappers[self::CALLBACK_POSITION] = array(9, 'callbackWrapperPosition');
     ...
     * BrickletLinearPotiV2::CALLBACK_POSITION callback. You can set the callback configuration
     * with BrickletLinearPotiV2::setPositionCallbackConfiguration().
     * 
     * 
     * @return int
     */
    public function getPosition()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_POSITION, $payload, 9);

        $payload = unpack('C1position', $data);

        return $payload['position'];
    }

    /**
     * The period is the period with which the BrickletLinearPotiV2::CALLBACK_POSITION callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletLinearPotiV2::CALLBACK_POSITION callback.
     * 
    ...
    /**
     * Returns the callback configuration as set by BrickletLinearPotiV2::setPositionCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getPositionCallbackConfiguration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_POSITION_CALLBACK_CONFIGURATION, $payload, 16);

        $payload = unpack('V1period/C1value_has_to_change/c1option/C1min/C1max', $data);
    ...
    /**
     * Returns the current bootloader mode, see BrickletLinearPotiV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletLinearPotiV2::writeFirmware(). The pointer has
     ...
     * BrickletLinearPotiV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletLinearPotiV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
