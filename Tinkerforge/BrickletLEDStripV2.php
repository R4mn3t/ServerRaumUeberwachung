...
class BrickletLEDStripV2 extends Device
{
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->callback_wrappers[self::CALLBACK_FRAME_STARTED] = array(10, 'callbackWrapperFrameStarted');
    ...
    public function setLEDValuesLowLevel($index, $value_length, $value_chunk_offset, $value_chunk_data)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_LED_VALUES_LOW_LEVEL, $payload, 0);
    }
    ...
    public function getLEDValuesLowLevel($index, $length)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_LED_VALUES_LOW_LEVEL, $payload, 72);
    ...
    /**
     * Returns the frame duration as set by BrickletLEDStripV2::setFrameDuration().
     * 
     * 
     * @return int
     */
    ...
    public function setFrameStartedCallbackConfiguration($enable)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_FRAME_STARTED_CALLBACK_CONFIGURATION, $payload, 0);
    }
    ...
    public function getFrameStartedCallbackConfiguration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_FRAME_STARTED_CALLBACK_CONFIGURATION, $payload, 9);
    ...
    public function setLEDValues($index, $value)
    {
        ...
        if ($value_length === 0) {
            $value_chunk_data = array_fill(0, 58, 0);
