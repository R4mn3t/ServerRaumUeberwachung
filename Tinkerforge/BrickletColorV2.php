 ...
 */
class BrickletColorV2 extends Device
{

    /**
     * This callback is triggered periodically with the period that is set by
     * BrickletColorV2::setColorCallbackConfiguration(). The parameter is the color
     * of the sensor as RGBC.
     * 
     * The BrickletColorV2::CALLBACK_COLOR callback is only triggered if the color has changed since the
     * last triggering.
     */
    const CALLBACK_COLOR = 4;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletColorV2::setIlluminanceCallbackConfiguration().
     * 
     * The parameter is the same as BrickletColorV2::getIlluminance().
     */
    const CALLBACK_ILLUMINANCE = 8;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletColorV2::setColorTemperatureCallbackConfiguration().
     * 
     * The parameter is the same as BrickletColorV2::getColorTemperature().
     */
    const CALLBACK_COLOR_TEMPERATURE = 12;
     ...
     * @internal
     */
    const FUNCTION_SET_COLOR_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_COLOR_CALLBACK_CONFIGURATION = 3;

    /**
     * @internal
     */
    const FUNCTION_GET_ILLUMINANCE = 5;

    /**
     * @internal
     */
    const FUNCTION_SET_ILLUMINANCE_CALLBACK_CONFIGURATION = 6;

    /**
     * @internal
     */
    const FUNCTION_GET_ILLUMINANCE_CALLBACK_CONFIGURATION = 7;

    /**
     * @internal
     */
    const FUNCTION_GET_COLOR_TEMPERATURE = 9;

    /**
     * @internal
     */
    const FUNCTION_SET_COLOR_TEMPERATURE_CALLBACK_CONFIGURATION = 10;

    /**
     * @internal
     */
    const FUNCTION_GET_COLOR_TEMPERATURE_CALLBACK_CONFIGURATION = 11;

    /**
     * @internal
     */
    const FUNCTION_SET_LIGHT = 13;

    /**
     * @internal
     */
    const FUNCTION_GET_LIGHT = 14;
    ...
    const DEVICE_IDENTIFIER = 2128;

    const DEVICE_DISPLAY_NAME = 'Color Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_COLOR_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_COLOR_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->response_expected[self::FUNCTION_SET_COLOR_TEMPERATURE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_COLOR_TEMPERATURE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_LIGHT] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_LIGHT] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
     ...
     * to use the BrickletColorV2::CALLBACK_COLOR callback and set the period with
     * BrickletColorV2::setColorCallbackConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * The period is the period with which the BrickletColorV2::CALLBACK_COLOR
     ...
     * @return void
     */
    public function setColorCallbackConfiguration($period, $value_has_to_change)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_COLOR_CALLBACK_CONFIGURATION, $payload, 0);
    }
     ...
     * @return array
     */
    public function getColorCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COLOR_CALLBACK_CONFIGURATION, $payload, 13);
     ...
     * set by BrickletColorV2::setConfiguration(). To get the illuminance in Lux apply this formula::
     * 
     ...
     * In that case you have to reduce the gain, see BrickletColorV2::setConfiguration().
     * 
     * 
     * If you want to get the value periodically, it is recommended to use the
     * BrickletColorV2::CALLBACK_ILLUMINANCE callback. You can set the callback configuration
     * with BrickletColorV2::setIlluminanceCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletColorV2::CALLBACK_ILLUMINANCE callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletColorV2::CALLBACK_ILLUMINANCE callback.
     * 
    ...
    /**
     * Returns the callback configuration as set by BrickletColorV2::setIlluminanceCallbackConfiguration().
     * 
     * 
     * @return array
     */
     ...
     * 
     * If you want to get the value periodically, it is recommended to use the
     * BrickletColorV2::CALLBACK_COLOR_TEMPERATURE callback. You can set the callback configuration
     * with BrickletColorV2::setColorTemperatureCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletColorV2::CALLBACK_COLOR_TEMPERATURE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * If the `value has to change`-parameter is set to true, the callback is only
     * triggered after the value has changed. If the value didn't change
     ...
     * It is furthermore possible to constrain the callback with thresholds.
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletColorV2::CALLBACK_COLOR_TEMPERATURE callback.
     * 
     * The following options are possible:
     * 
     * <code>
     ...
     * @return void
     */
    public function setColorTemperatureCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_COLOR_TEMPERATURE_CALLBACK_CONFIGURATION, $payload, 0);
    }

    /**
     * Returns the callback configuration as set by BrickletColorV2::setColorTemperatureCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getColorTemperatureCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COLOR_TEMPERATURE_CALLBACK_CONFIGURATION, $payload, 18);
     ...
     * @return void
     */
    public function setLight($enable)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_LIGHT, $payload, 0);
    }

    /**
     * Returns the value as set by BrickletColorV2::setLight().
     * 
     * 
     * @return bool
     */
    public function getLight()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_LIGHT, $payload, 9);
     ...
     * @return void
     */
    public function setConfiguration($gain, $integration_time)
    {
        $this->checkValidity();
    ...
    /**
     * Returns the configuration as set by BrickletColorV2::setConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the current bootloader mode, see BrickletColorV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletColorV2::writeFirmware(). The pointer has
     ...
     * BrickletColorV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletColorV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
