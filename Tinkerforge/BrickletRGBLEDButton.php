 ...
 */
class BrickletRGBLEDButton extends Device
{
     ...
     */
    const CALLBACK_BUTTON_STATE_CHANGED = 4;


    /**
     * @internal
     */
    const FUNCTION_SET_COLOR = 1;

    /**
     * @internal
     */
    const FUNCTION_GET_COLOR = 2;
     ...
     * @internal
     */
    const FUNCTION_SET_COLOR_CALIBRATION = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_COLOR_CALIBRATION = 6;
    ...
    const DEVICE_IDENTIFIER = 282;

    const DEVICE_DISPLAY_NAME = 'RGB LED Button Bricklet';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_COLOR] = self::RESPONSE_EXPECTED_FALSE;
        ...
        $this->response_expected[self::FUNCTION_SET_COLOR_CALIBRATION] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_COLOR_CALIBRATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->callback_wrappers[self::CALLBACK_BUTTON_STATE_CHANGED] = array(9, 'callbackWrapperButtonStateChanged');
    ...
    public function setColor($red, $green, $blue)
    {
        ...
        $payload = '';
        $payload .= pack('C', $red);
        $payload .= pack('C', $green);
        $payload .= pack('C', $blue);

        $this->sendRequest(self::FUNCTION_SET_COLOR, $payload, 0);
    }

    /**
     * Returns the LED color as set by BrickletRGBLEDButton::setColor().
     * 
     * 
     * @return array
     */
    public function getColor()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COLOR, $payload, 11);

        $payload = unpack('C1red/C1green/C1blue', $data);

        $ret['red'] = $payload['red'];
        $ret['green'] = $payload['green'];
        $ret['blue'] = $payload['blue'];
    ...
    public function getButtonState()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_BUTTON_STATE, $payload, 9);
     ...
     * @return void
     */
    public function setColorCalibration($red, $green, $blue)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_COLOR_CALIBRATION, $payload, 0);
    }

    /**
     * Returns the color calibration as set by BrickletRGBLEDButton::setColorCalibration().
     * 
     * 
     * @return array
     */
    public function getColorCalibration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COLOR_CALIBRATION, $payload, 11);
    ...
    /**
     * Returns the current bootloader mode, see BrickletRGBLEDButton::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletRGBLEDButton::writeFirmware(). The pointer has
     ...
     * BrickletRGBLEDButton::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletRGBLEDButton::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
     ...
     * @param string $data
     */
    public function callbackWrapperButtonStateChanged($data)
    {
        $payload = unpack('C1state', $data);

        if (array_key_exists(self::CALLBACK_BUTTON_STATE_CHANGED, $this->registered_callbacks)) {
            $function = $this->registered_callbacks[self::CALLBACK_BUTTON_STATE_CHANGED];
            $user_data = $this->registered_callback_user_data[self::CALLBACK_BUTTON_STATE_CHANGED];
