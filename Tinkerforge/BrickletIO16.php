...
class BrickletIO16 extends Device
{
    ...
    const DEVICE_DISPLAY_NAME = 'IO-16 Bricklet';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_PORT] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_PORT] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_PORT_CONFIGURATION] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_PORT_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->response_expected[self::FUNCTION_SET_PORT_INTERRUPT] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_PORT_INTERRUPT] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_PORT_MONOFLOP] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_PORT_MONOFLOP] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->callback_wrappers[self::CALLBACK_INTERRUPT] = array(11, 'callbackWrapperInterrupt');
        $this->callback_wrappers[self::CALLBACK_MONOFLOP_DONE] = array(11, 'callbackWrapperMonoflopDone');
    ...
    public function setPort($port, $value_mask)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_PORT, $payload, 0);
    }
    ...
    public function getPort($port)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_PORT, $payload, 9);
    ...
    public function setPortConfiguration($port, $selection_mask, $direction, $value)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_PORT_CONFIGURATION, $payload, 0);
    }
    ...
    public function getPortConfiguration($port)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_PORT_CONFIGURATION, $payload, 10);
    ...
    /**
     * Sets the debounce period of the BrickletIO16::CALLBACK_INTERRUPT callback.
     * 
     ...
     * 
     * The interrupt is delivered with the BrickletIO16::CALLBACK_INTERRUPT callback.
     * 
     * @param string $port
    ...
    public function setPortInterrupt($port, $interrupt_mask)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_PORT_INTERRUPT, $payload, 0);
    }
    ...
    public function getPortInterrupt($port)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_PORT_INTERRUPT, $payload, 9);
    ...
    public function setPortMonoflop($port, $selection_mask, $value_mask, $time)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_PORT_MONOFLOP, $payload, 0);
    }
    ...
    public function getPortMonoflop($port, $pin)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_PORT_MONOFLOP, $payload, 17);
    ...
    public function callbackWrapperInterrupt($data)
    {
        ...
        if (array_key_exists(self::CALLBACK_INTERRUPT, $this->registered_callbacks)) {
            ...
            call_user_func($function, $payload['port'], $payload['interrupt_mask'], $payload['value_mask'], $user_data);
        }
    }
    ...
    public function callbackWrapperMonoflopDone($data)
    {
        ...
        if (array_key_exists(self::CALLBACK_MONOFLOP_DONE, $this->registered_callbacks)) {
            ...
            call_user_func($function, $payload['port'], $payload['selection_mask'], $payload['value_mask'], $user_data);
        }
    }
}
