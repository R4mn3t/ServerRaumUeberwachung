 ...
 */
class BrickletIO16V2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletIO16V2::setInputValueCallbackConfiguration().
     * 
     ...
     * the last callback.
     */
    const CALLBACK_INPUT_VALUE = 15;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletIO16V2::setAllInputValueCallbackConfiguration().
     * 
     * The parameters are the same as BrickletIO16V2::getValue(). Additional the
     * `changed` parameter is true if the value has changed since
     * the last callback.
     */
    const CALLBACK_ALL_INPUT_VALUE = 16;
     ...
     */
    const CALLBACK_MONOFLOP_DONE = 17;
    ...
    const DEVICE_IDENTIFIER = 2114;

    const DEVICE_DISPLAY_NAME = 'IO-16 Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->callback_wrappers[self::CALLBACK_ALL_INPUT_VALUE] = array(12, 'callbackWrapperAllInputValue');
     ...
     * 
     * Use BrickletIO16V2::setSelectedValue() to change only one output channel state.
     * 
     ...
     *  resistors can be switched on with BrickletIO16V2::setConfiguration().
     * </note>
     * 
     * @param bool[] $value
     * 
    ...
    public function getValue()
    {
        ...
        $payload = unpack('C2value', $data);

        return IPConnection::collectUnpackedBoolArray($payload, 'value', 16);
    }
    ...
    /**
     * Returns the channel configuration as set by BrickletIO16V2::setConfiguration().
     * 
     * @param int $channel
     * 
     * @return array
     ...
     * 
     * The period is the period with which the BrickletIO16V2::CALLBACK_INPUT_VALUE
    ...
    /**
     * The period is the period with which the BrickletIO16V2::CALLBACK_ALL_INPUT_VALUE
     * callback is triggered periodically. A value of 0 turns the callback off.
     * 
     * If the `value has to change`-parameter is set to true, the callback is only
     * triggered after the value has changed. If the value didn't change within the
     ...
     * BrickletIO16V2::setMonoflop() as well as the remaining time until the value flips.
     * 
     ...
     * configure the edges that are counted with BrickletIO16V2::setEdgeCountConfiguration().
     * 
     ...
     * BrickletIO16V2::setEdgeCountConfiguration().
     * 
     * @param int $channel
     * 
     * @return array
    ...
    /**
     * Returns the current bootloader mode, see BrickletIO16V2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletIO16V2::writeFirmware(). The pointer has
     ...
     * BrickletIO16V2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletIO16V2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
    ...
    {
        $payload = unpack('C2changed/C2value', $data);
        $payload['changed'] = IPConnection::collectUnpackedBoolArray($payload, 'changed', 16);
        $payload['value'] = IPConnection::collectUnpackedBoolArray($payload, 'value', 16);
