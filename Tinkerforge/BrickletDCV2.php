 ...
 */
class BrickletDCV2 extends Device
{
     ...
     * That means, BrickletDCV2::setEnabled() has to be called to drive the motor again.
     * 
     * <note>
     *  This callback only works in Drive/Brake mode (see BrickletDCV2::setDriveMode()). In
     ...
     * to 10000, the BrickletDCV2::CALLBACK_VELOCITY_REACHED callback will be triggered after about
     * 2 seconds, when the set velocity is actually reached.
     * 
     * <note>
     *  Since we can't get any feedback from the DC motor, this only works if the
     *  acceleration (see BrickletDCV2::setMotion()) is set smaller or equal to the
     ...
     * BrickletDCV2::setCurrentVelocityCallbackConfiguration(). The parameter is the *current*
     * velocity used by the motor.
     * 
     * The BrickletDCV2::CALLBACK_CURRENT_VELOCITY callback is only triggered after the set period
     ...
     * @internal
     */
    const FUNCTION_SET_EMERGENCY_SHUTDOWN_CALLBACK_CONFIGURATION = 16;

    /**
     * @internal
     */
    const FUNCTION_GET_EMERGENCY_SHUTDOWN_CALLBACK_CONFIGURATION = 17;

    /**
     * @internal
     */
    const FUNCTION_SET_VELOCITY_REACHED_CALLBACK_CONFIGURATION = 18;

    /**
     * @internal
     */
    const FUNCTION_GET_VELOCITY_REACHED_CALLBACK_CONFIGURATION = 19;

    /**
     * @internal
     */
    const FUNCTION_SET_CURRENT_VELOCITY_CALLBACK_CONFIGURATION = 20;

    /**
     * @internal
     */
    const FUNCTION_GET_CURRENT_VELOCITY_CALLBACK_CONFIGURATION = 21;
    ...
    const DEVICE_IDENTIFIER = 2165;

    const DEVICE_DISPLAY_NAME = 'DC Bricklet 2.0';
     ...
     * acceleration (see BrickletDCV2::setMotion()), the motor is not immediately
     * brought to the velocity but smoothly accelerated.
     * 
     * The velocity describes the duty cycle of the PWM with which the motor is
     * controlled, e.g. a velocity of 3277 sets a PWM with a 10% duty cycle.
     * You can not only control the duty cycle of the PWM but also the frequency,
     * see BrickletDCV2::setPWMFrequency().
     * 
     * @param int $velocity
     * 
     * @return void
    ...
    /**
     * Returns the velocity as set by BrickletDCV2::setVelocity().
     * 
     * 
     * @return int
     */
     ...
     * from BrickletDCV2::getVelocity() whenever the motor is currently accelerating
     * to a goal set by BrickletDCV2::setVelocity().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Returns the acceleration/deceleration as set by BrickletDCV2::setMotion().
     * 
     * 
     * @return array
     */
     ...
     * </warning>
     * 
     * Call BrickletDCV2::setVelocity() with 0 if you just want to stop the motor.
     * 
     * 
     * @return void
     */
    ...
    /**
     * Returns the drive mode, as set by BrickletDCV2::setDriveMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Returns the PWM frequency as set by BrickletDCV2::setPWMFrequency().
     * 
     * 
     * @return int
     */
    ...
    public function getPowerStatistics()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_POWER_STATISTICS, $payload, 12);

        $payload = unpack('v1voltage/v1current', $data);
    ...
    /**
     * Returns the LED configuration as set by BrickletDCV2::setErrorLEDConfig()
     * 
     * 
     * @return int
     */
    ...
    /**
     * Enable/Disable BrickletDCV2::CALLBACK_EMERGENCY_SHUTDOWN callback.
     * 
     * @param bool $enabled
     * 
     * @return void
     ...
     * BrickletDCV2::setEmergencyShutdownCallbackConfiguration().
     * 
     * 
     * @return bool
     */
    ...
    /**
     * Enable/Disable BrickletDCV2::CALLBACK_VELOCITY_REACHED callback.
     * 
     * @param bool $enabled
     * 
     * @return void
    ...
    /**
     * Returns the callback configuration as set by
     * BrickletDCV2::setVelocityReachedCallbackConfiguration().
     * 
     * 
     * @return bool
     */
    ...
    /**
     * The period is the period with which the BrickletDCV2::CALLBACK_CURRENT_VELOCITY
    ...
    /**
     * Returns the callback configuration as set by
     * BrickletDCV2::setCurrentVelocityCallbackConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the current bootloader mode, see BrickletDCV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletDCV2::writeFirmware(). The pointer has
     ...
     * BrickletDCV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletDCV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
