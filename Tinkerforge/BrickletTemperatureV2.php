 ...
 */
class BrickletTemperatureV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletTemperatureV2::setTemperatureCallbackConfiguration().
     * 
     * The parameter is the same as BrickletTemperatureV2::getTemperature().
     */
     ...
     * @internal
     */
    const FUNCTION_SET_HEATER_CONFIGURATION = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_HEATER_CONFIGURATION = 6;
    ...
    const DEVICE_IDENTIFIER = 2113;

    const DEVICE_DISPLAY_NAME = 'Temperature Bricklet 2.0';
     ...
     * BrickletTemperatureV2::CALLBACK_TEMPERATURE callback. You can set the callback configuration
     * with BrickletTemperatureV2::setTemperatureCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletTemperatureV2::CALLBACK_TEMPERATURE callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletTemperatureV2::CALLBACK_TEMPERATURE callback.
     * 
    ...
    /**
     * Returns the callback configuration as set by BrickletTemperatureV2::setTemperatureCallbackConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the heater configuration as set by BrickletTemperatureV2::setHeaterConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Returns the current bootloader mode, see BrickletTemperatureV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletTemperatureV2::writeFirmware(). The pointer has
     ...
     * BrickletTemperatureV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletTemperatureV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
