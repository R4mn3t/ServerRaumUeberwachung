 ...
 */
class BrickletAnalogInV3 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletAnalogInV3::setVoltageCallbackConfiguration().
     * 
     * The parameter is the same as BrickletAnalogInV3::getVoltage().
     */
     ...
     * @internal
     */
    const FUNCTION_SET_OVERSAMPLING = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_OVERSAMPLING = 6;
    ...
    const OVERSAMPLING_32 = 0;
    const OVERSAMPLING_64 = 1;
    const OVERSAMPLING_128 = 2;
    const OVERSAMPLING_256 = 3;
    const OVERSAMPLING_512 = 4;
    const OVERSAMPLING_1024 = 5;
    const OVERSAMPLING_2048 = 6;
    const OVERSAMPLING_4096 = 7;
    const OVERSAMPLING_8192 = 8;
    const OVERSAMPLING_16384 = 9;
    ...
    const DEVICE_IDENTIFIER = 295;

    const DEVICE_DISPLAY_NAME = 'Analog In Bricklet 3.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_OVERSAMPLING] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_OVERSAMPLING] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
     ...
     * depending on the oversampling configuration (BrickletAnalogInV3::setOversampling()).
     * 
     * 
     * If you want to get the value periodically, it is recommended to use the
     * BrickletAnalogInV3::CALLBACK_VOLTAGE callback. You can set the callback configuration
     * with BrickletAnalogInV3::setVoltageCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletAnalogInV3::CALLBACK_VOLTAGE callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletAnalogInV3::CALLBACK_VOLTAGE callback.
     * 
    ...
    /**
     * Returns the callback configuration as set by BrickletAnalogInV3::setVoltageCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getVoltageCallbackConfiguration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_VOLTAGE_CALLBACK_CONFIGURATION, $payload, 18);
     ...
     * @return void
     */
    public function setOversampling($oversampling)
    {
        $this->checkValidity();

        $payload = '';
        $payload .= pack('C', $oversampling);

        $this->sendRequest(self::FUNCTION_SET_OVERSAMPLING, $payload, 0);
    }

    /**
     * Returns the oversampling value as set by BrickletAnalogInV3::setOversampling().
     * 
     * 
     * @return int
     */
    public function getOversampling()
    {
        $this->checkValidity();

        $payload = '';

        $data = $this->sendRequest(self::FUNCTION_GET_OVERSAMPLING, $payload, 9);

        $payload = unpack('C1oversampling', $data);

        return $payload['oversampling'];
    }
     ...
     * @return void
     */
    public function setCalibration($offset, $multiplier, $divisor)
    {
        $this->checkValidity();

        $payload = '';
        $payload .= pack('v', $offset);
        $payload .= pack('v', $multiplier);
        $payload .= pack('v', $divisor);

        $this->sendRequest(self::FUNCTION_SET_CALIBRATION, $payload, 0);
    }

    /**
     * Returns the calibration as set by BrickletAnalogInV3::setCalibration().
     * 
     * 
     * @return array
     */
    public function getCalibration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_CALIBRATION, $payload, 14);

        $payload = unpack('v1offset/v1multiplier/v1divisor', $data);

        $ret['offset'] = IPConnection::fixUnpackedInt16($payload, 'offset');
        $ret['multiplier'] = $payload['multiplier'];
        $ret['divisor'] = $payload['divisor'];
    ...
    /**
     * Returns the current bootloader mode, see BrickletAnalogInV3::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletAnalogInV3::writeFirmware(). The pointer has
     ...
     * BrickletAnalogInV3::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletAnalogInV3::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
