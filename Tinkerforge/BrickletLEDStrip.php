...
class BrickletLEDStrip extends Device
{
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->callback_wrappers[self::CALLBACK_FRAME_RENDERED] = array(10, 'callbackWrapperFrameRendered');
    ...
    public function setRGBValues($index, $length, $r, $g, $b)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_RGB_VALUES, $payload, 0);
    }
    ...
    public function getRGBValues($index, $length)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_RGB_VALUES, $payload, 56);
    ...
    public function setClockFrequency($frequency)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_CLOCK_FREQUENCY, $payload, 0);
    }
    ...
    public function getClockFrequency()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_CLOCK_FREQUENCY, $payload, 12);
    ...
    public function setChipType($chip)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_CHIP_TYPE, $payload, 0);
    }
    ...
    public function getChipType()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_CHIP_TYPE, $payload, 10);
    ...
    public function setRGBWValues($index, $length, $r, $g, $b, $w)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_RGBW_VALUES, $payload, 0);
    }
    ...
    public function getRGBWValues($index, $length)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_RGBW_VALUES, $payload, 56);
    ...
    public function setChannelMapping($mapping)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_CHANNEL_MAPPING, $payload, 0);
    }
    ...
    public function getChannelMapping()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_CHANNEL_MAPPING, $payload, 9);
    ...
    public function enableFrameRenderedCallback()
    {
        ...
        $this->sendRequest(self::FUNCTION_ENABLE_FRAME_RENDERED_CALLBACK, $payload, 0);
    }
    ...
    public function disableFrameRenderedCallback()
    {
        ...
        $this->sendRequest(self::FUNCTION_DISABLE_FRAME_RENDERED_CALLBACK, $payload, 0);
    }
    ...
    public function isFrameRenderedCallbackEnabled()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_IS_FRAME_RENDERED_CALLBACK_ENABLED, $payload, 9);
