 ...
 */
class BrickHATZero extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickHATZero::setUSBVoltageCallbackConfiguration().
     * 
     * The parameter is the same as BrickHATZero::getUSBVoltage().
     * 
     * .. versionadded:: 2.0.1$nbsp;(Firmware)
     */
    const CALLBACK_USB_VOLTAGE = 4;


    /**
     * @internal
     */
    const FUNCTION_GET_USB_VOLTAGE = 1;

    /**
     * @internal
     */
    const FUNCTION_SET_USB_VOLTAGE_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_USB_VOLTAGE_CALLBACK_CONFIGURATION = 3;
    ...
    const DEVICE_IDENTIFIER = 112;

    const DEVICE_DISPLAY_NAME = 'HAT Zero Brick';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_USB_VOLTAGE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_USB_VOLTAGE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
     ...
     * BrickHATZero::CALLBACK_USB_VOLTAGE callback. You can set the callback configuration
     * with BrickHATZero::setUSBVoltageCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickHATZero::CALLBACK_USB_VOLTAGE callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickHATZero::CALLBACK_USB_VOLTAGE callback.
     * 
     ...
     * @return void
     */
    public function setUSBVoltageCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_USB_VOLTAGE_CALLBACK_CONFIGURATION, $payload, 0);
    }

    /**
     * Returns the callback configuration as set by BrickHATZero::setUSBVoltageCallbackConfiguration().
     * 
     * .. versionadded:: 2.0.1$nbsp;(Firmware)
     * 
     * 
     * @return array
     */
    public function getUSBVoltageCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_USB_VOLTAGE_CALLBACK_CONFIGURATION, $payload, 18);
    ...
    /**
     * Returns the current bootloader mode, see BrickHATZero::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickHATZero::writeFirmware(). The pointer has
     ...
     * BrickHATZero::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickHATZero::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
