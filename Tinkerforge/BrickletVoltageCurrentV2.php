 ...
 */
class BrickletVoltageCurrentV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletVoltageCurrentV2::setCurrentCallbackConfiguration().
     * 
     * The parameter is the same as BrickletVoltageCurrentV2::getCurrent().
     */
    const CALLBACK_CURRENT = 4;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletVoltageCurrentV2::setVoltageCallbackConfiguration().
     * 
     * The parameter is the same as BrickletVoltageCurrentV2::getVoltage().
     */
    const CALLBACK_VOLTAGE = 8;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletVoltageCurrentV2::setPowerCallbackConfiguration().
     * 
     * The parameter is the same as BrickletVoltageCurrentV2::getPower().
     */
    const CALLBACK_POWER = 12;
     ...
     * @internal
     */
    const FUNCTION_SET_VOLTAGE_CALLBACK_CONFIGURATION = 6;

    /**
     * @internal
     */
    const FUNCTION_GET_VOLTAGE_CALLBACK_CONFIGURATION = 7;

    /**
     * @internal
     */
    const FUNCTION_GET_POWER = 9;

    /**
     * @internal
     */
    const FUNCTION_SET_POWER_CALLBACK_CONFIGURATION = 10;

    /**
     * @internal
     */
    const FUNCTION_GET_POWER_CALLBACK_CONFIGURATION = 11;
     ...
     * @internal
     */
    const FUNCTION_SET_CALIBRATION = 15;

    /**
     * @internal
     */
    const FUNCTION_GET_CALIBRATION = 16;
    ...
    const DEVICE_IDENTIFIER = 2105;

    const DEVICE_DISPLAY_NAME = 'Voltage/Current Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_POWER_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_POWER_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
     ...
     * BrickletVoltageCurrentV2::CALLBACK_CURRENT callback. You can set the callback configuration
     * with BrickletVoltageCurrentV2::setCurrentCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletVoltageCurrentV2::CALLBACK_CURRENT callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletVoltageCurrentV2::CALLBACK_CURRENT callback.
     * 
     ...
     * @return void
     */
    public function setCurrentCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
    ...
    /**
     * Returns the callback configuration as set by BrickletVoltageCurrentV2::setCurrentCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getCurrentCallbackConfiguration()
    {
        $this->checkValidity();
     ...
     * 
     * If you want to get the value periodically, it is recommended to use the
     * BrickletVoltageCurrentV2::CALLBACK_VOLTAGE callback. You can set the callback configuration
     * with BrickletVoltageCurrentV2::setVoltageCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletVoltageCurrentV2::CALLBACK_VOLTAGE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * If the `value has to change`-parameter is set to true, the callback is only
     * triggered after the value has changed. If the value didn't change
     ...
     * It is furthermore possible to constrain the callback with thresholds.
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletVoltageCurrentV2::CALLBACK_VOLTAGE callback.
     * 
     * The following options are possible:
     * 
     * <code>
     ...
     * @return void
     */
    public function setVoltageCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
    ...
    /**
     * Returns the callback configuration as set by BrickletVoltageCurrentV2::setVoltageCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getVoltageCallbackConfiguration()
    {
        $this->checkValidity();
     ...
     * 
     * If you want to get the value periodically, it is recommended to use the
     * BrickletVoltageCurrentV2::CALLBACK_POWER callback. You can set the callback configuration
     * with BrickletVoltageCurrentV2::setPowerCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletVoltageCurrentV2::CALLBACK_POWER callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * If the `value has to change`-parameter is set to true, the callback is only
     * triggered after the value has changed. If the value didn't change
     ...
     * It is furthermore possible to constrain the callback with thresholds.
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletVoltageCurrentV2::CALLBACK_POWER callback.
     * 
     * The following options are possible:
     * 
     * <code>
     ...
     * @return void
     */
    public function setPowerCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_POWER_CALLBACK_CONFIGURATION, $payload, 0);
    }

    /**
     * Returns the callback configuration as set by BrickletVoltageCurrentV2::setPowerCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getPowerCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_POWER_CALLBACK_CONFIGURATION, $payload, 22);
    ...
    /**
     * Returns the configuration as set by BrickletVoltageCurrentV2::setConfiguration().
     * 
     * 
     * @return array
     */
     ...
     * 
     * @param int $voltage_multiplier
     * @param int $voltage_divisor
     * @param int $current_multiplier
     * @param int $current_divisor
     * 
     * @return void
     */
    public function setCalibration($voltage_multiplier, $voltage_divisor, $current_multiplier, $current_divisor)
    {
        $this->checkValidity();

        $payload = '';
        $payload .= pack('v', $voltage_multiplier);
        $payload .= pack('v', $voltage_divisor);
        $payload .= pack('v', $current_multiplier);
        $payload .= pack('v', $current_divisor);

        $this->sendRequest(self::FUNCTION_SET_CALIBRATION, $payload, 0);
    }

    /**
     * Returns the calibration as set by BrickletVoltageCurrentV2::setCalibration().
     * 
     * 
     * @return array
     */
    public function getCalibration()
    {
        ...
        $payload = unpack('v1voltage_multiplier/v1voltage_divisor/v1current_multiplier/v1current_divisor', $data);

        $ret['voltage_multiplier'] = $payload['voltage_multiplier'];
        $ret['voltage_divisor'] = $payload['voltage_divisor'];
        $ret['current_multiplier'] = $payload['current_multiplier'];
        $ret['current_divisor'] = $payload['current_divisor'];
    ...
    /**
     * Returns the current bootloader mode, see BrickletVoltageCurrentV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletVoltageCurrentV2::writeFirmware(). The pointer has
     ...
     * BrickletVoltageCurrentV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletVoltageCurrentV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
