 ...
 */
class BrickletHallEffectV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletHallEffectV2::setMagneticFluxDensityCallbackConfiguration().
     * 
     * The parameter is the same as BrickletHallEffectV2::getMagneticFluxDensity().
     */
    const CALLBACK_MAGNETIC_FLUX_DENSITY = 4;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletHallEffectV2::setCounterCallbackConfiguration().
     * 
     * The count is the same as you would get with BrickletHallEffectV2::getCounter().
     */
    const CALLBACK_COUNTER = 10;


    /**
     * @internal
     */
    const FUNCTION_GET_MAGNETIC_FLUX_DENSITY = 1;

    /**
     * @internal
     */
    const FUNCTION_SET_MAGNETIC_FLUX_DENSITY_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_MAGNETIC_FLUX_DENSITY_CALLBACK_CONFIGURATION = 3;

    /**
     * @internal
     */
    const FUNCTION_GET_COUNTER = 5;

    /**
     * @internal
     */
    const FUNCTION_SET_COUNTER_CONFIG = 6;

    /**
     * @internal
     */
    const FUNCTION_GET_COUNTER_CONFIG = 7;

    /**
     * @internal
     */
    const FUNCTION_SET_COUNTER_CALLBACK_CONFIGURATION = 8;

    /**
     * @internal
     */
    const FUNCTION_GET_COUNTER_CALLBACK_CONFIGURATION = 9;
    ...
    const DEVICE_IDENTIFIER = 2132;

    const DEVICE_DISPLAY_NAME = 'Hall Effect Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_COUNTER_CONFIG] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_COUNTER_CONFIG] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_COUNTER_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_COUNTER_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->callback_wrappers[self::CALLBACK_MAGNETIC_FLUX_DENSITY] = array(10, 'callbackWrapperMagneticFluxDensity');
        $this->callback_wrappers[self::CALLBACK_COUNTER] = array(12, 'callbackWrapperCounter');
     ...
     * BrickletHallEffectV2::CALLBACK_MAGNETIC_FLUX_DENSITY callback. You can set the callback configuration
     * with BrickletHallEffectV2::setMagneticFluxDensityCallbackConfiguration().
     * 
     * 
     * @return int
     */
    public function getMagneticFluxDensity()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_MAGNETIC_FLUX_DENSITY, $payload, 10);

        $payload = unpack('v1magnetic_flux_density', $data);

        return IPConnection::fixUnpackedInt16($payload, 'magnetic_flux_density');
    }

    /**
     * The period is the period with which the BrickletHallEffectV2::CALLBACK_MAGNETIC_FLUX_DENSITY callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletHallEffectV2::CALLBACK_MAGNETIC_FLUX_DENSITY callback.
     * 
     ...
     * @return void
     */
    public function setMagneticFluxDensityCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
    ...
    /**
     * Returns the callback configuration as set by BrickletHallEffectV2::setMagneticFluxDensityCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getMagneticFluxDensityCallbackConfiguration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_MAGNETIC_FLUX_DENSITY_CALLBACK_CONFIGURATION, $payload, 18);
     ...
     * with BrickletHallEffectV2::setCounterConfig().
     * 
     ...
     * BrickletHallEffectV2::CALLBACK_COUNTER callback. You can set the callback configuration
     * with BrickletHallEffectV2::setCounterCallbackConfiguration().
     * 
     * @param bool $reset_counter
     * 
     * @return int
     */
    public function getCounter($reset_counter)
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COUNTER, $payload, 12);
     ...
     * 
     * @param int $high_threshold
     * @param int $low_threshold
     * @param int $debounce
     * 
     * @return void
     */
    public function setCounterConfig($high_threshold, $low_threshold, $debounce)
    {
        $this->checkValidity();

        $payload = '';
        $payload .= pack('v', $high_threshold);
        $payload .= pack('v', $low_threshold);
        $payload .= pack('V', $debounce);

        $this->sendRequest(self::FUNCTION_SET_COUNTER_CONFIG, $payload, 0);
    }

    /**
     * Returns the counter config as set by BrickletHallEffectV2::setCounterConfig().
     * 
     * 
     * @return array
     */
    public function getCounterConfig()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COUNTER_CONFIG, $payload, 16);

        $payload = unpack('v1high_threshold/v1low_threshold/V1debounce', $data);

        $ret['high_threshold'] = IPConnection::fixUnpackedInt16($payload, 'high_threshold');
        $ret['low_threshold'] = IPConnection::fixUnpackedInt16($payload, 'low_threshold');
        $ret['debounce'] = IPConnection::fixUnpackedUInt32($payload, 'debounce');

        return $ret;
    }

    /**
     * The period is the period with which the BrickletHallEffectV2::CALLBACK_COUNTER
     ...
     * @return void
     */
    public function setCounterCallbackConfiguration($period, $value_has_to_change)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_COUNTER_CALLBACK_CONFIGURATION, $payload, 0);
    }
     ...
     * @return array
     */
    public function getCounterCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_COUNTER_CALLBACK_CONFIGURATION, $payload, 13);
    ...
    /**
     * Returns the current bootloader mode, see BrickletHallEffectV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletHallEffectV2::writeFirmware(). The pointer has
     ...
     * BrickletHallEffectV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletHallEffectV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
    ...
    {
        $payload = unpack('v1magnetic_flux_density', $data);
        $payload['magnetic_flux_density'] = IPConnection::fixUnpackedInt16($payload, 'magnetic_flux_density');
        ...
        if (array_key_exists(self::CALLBACK_MAGNETIC_FLUX_DENSITY, $this->registered_callbacks)) {
            ...
            call_user_func($function, $payload['magnetic_flux_density'], $user_data);
        }
    }
     ...
     * @param string $data
     */
    public function callbackWrapperCounter($data)
    {
        $payload = unpack('V1count', $data);
        $payload['count'] = IPConnection::fixUnpackedUInt32($payload, 'count');

        if (array_key_exists(self::CALLBACK_COUNTER, $this->registered_callbacks)) {
            $function = $this->registered_callbacks[self::CALLBACK_COUNTER];
            $user_data = $this->registered_callback_user_data[self::CALLBACK_COUNTER];
