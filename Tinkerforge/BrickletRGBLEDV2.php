 ...
 */
class BrickletRGBLEDV2 extends Device
{
    ...
    const DEVICE_IDENTIFIER = 2127;

    const DEVICE_DISPLAY_NAME = 'RGB LED Bricklet 2.0';
    ...
    /**
     * Returns the *r*, *g* and *b* values of the LED as set by BrickletRGBLEDV2::setRGBValue().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the current bootloader mode, see BrickletRGBLEDV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletRGBLEDV2::writeFirmware(). The pointer has
     ...
     * BrickletRGBLEDV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletRGBLEDV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
