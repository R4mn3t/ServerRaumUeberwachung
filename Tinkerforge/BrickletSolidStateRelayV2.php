 ...
 */
class BrickletSolidStateRelayV2 extends Device
{
    ...
    const DEVICE_IDENTIFIER = 296;

    const DEVICE_DISPLAY_NAME = 'Solid State Relay Bricklet 2.0';
     ...
     * BrickletSolidStateRelayV2::setMonoflop() as well as the remaining time until the state flips.
     * 
    ...
    /**
     * Returns the current bootloader mode, see BrickletSolidStateRelayV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletSolidStateRelayV2::writeFirmware(). The pointer has
     ...
     * BrickletSolidStateRelayV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletSolidStateRelayV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
