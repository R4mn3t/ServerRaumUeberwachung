...
class BrickletAmbientLight extends Device
{
     ...
     * 
     * The BrickletAmbientLight::CALLBACK_ILLUMINANCE callback is only triggered if the illuminance has changed
     ...
     * ambient light sensor.
     * 
     * The BrickletAmbientLight::CALLBACK_ANALOG_VALUE callback is only triggered if the analog value has
    ...
    const DEVICE_DISPLAY_NAME = 'Ambient Light Bricklet';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->callback_wrappers[self::CALLBACK_ILLUMINANCE] = array(10, 'callbackWrapperIlluminance');
        $this->callback_wrappers[self::CALLBACK_ANALOG_VALUE] = array(10, 'callbackWrapperAnalogValue');
        $this->callback_wrappers[self::CALLBACK_ILLUMINANCE_REACHED] = array(10, 'callbackWrapperIlluminanceReached');
     ...
     * BrickletAmbientLight::CALLBACK_ILLUMINANCE callback and set the period with
    ...
    public function getIlluminance()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_ILLUMINANCE, $payload, 10);
     ...
     * BrickletAmbientLight::CALLBACK_ANALOG_VALUE callback and set the period with
    ...
    /**
     * Sets the period with which the BrickletAmbientLight::CALLBACK_ILLUMINANCE callback is triggered
    ...
    /**
     * Sets the period with which the BrickletAmbientLight::CALLBACK_ANALOG_VALUE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * The BrickletAmbientLight::CALLBACK_ANALOG_VALUE callback is only triggered if the analog value has
     * changed since the last triggering.
    ...
    public function getIlluminanceCallbackThreshold()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_ILLUMINANCE_CALLBACK_THRESHOLD, $payload, 13);
