...
class BrickletLCD20x4 extends Device
{
    ...
    const DEVICE_DISPLAY_NAME = 'LCD 20x4 Bricklet';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_BACKLIGHT_ON] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_BACKLIGHT_OFF] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_IS_BACKLIGHT_ON] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->response_expected[self::FUNCTION_IS_BUTTON_PRESSED] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_CUSTOM_CHARACTER] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_CUSTOM_CHARACTER] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_DEFAULT_TEXT] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_DEFAULT_TEXT] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_DEFAULT_TEXT_COUNTER] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_DEFAULT_TEXT_COUNTER] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_GET_IDENTITY] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;

        $this->callback_wrappers[self::CALLBACK_BUTTON_PRESSED] = array(9, 'callbackWrapperButtonPressed');
        $this->callback_wrappers[self::CALLBACK_BUTTON_RELEASED] = array(9, 'callbackWrapperButtonReleased');
    ...
    public function backlightOn()
    {
        ...
        $this->sendRequest(self::FUNCTION_BACKLIGHT_ON, $payload, 0);
    }
    ...
    public function backlightOff()
    {
        ...
        $this->sendRequest(self::FUNCTION_BACKLIGHT_OFF, $payload, 0);
    }
    ...
    public function isBacklightOn()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_IS_BACKLIGHT_ON, $payload, 9);
    ...
    public function getConfig()
    {
        ...
        $ret['cursor'] = (bool)$payload['cursor'];
        $ret['blinking'] = (bool)$payload['blinking'];
     ...
     * the BrickletLCD20x4::CALLBACK_BUTTON_PRESSED and BrickletLCD20x4::CALLBACK_BUTTON_RELEASED callbacks.
     * 
     * @param int $button
     * 
     * @return bool
    ...
    public function isButtonPressed($button)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_IS_BUTTON_PRESSED, $payload, 9);
    ...
    public function setCustomCharacter($index, $character)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_CUSTOM_CHARACTER, $payload, 0);
    }
    ...
    public function getCustomCharacter($index)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_CUSTOM_CHARACTER, $payload, 16);
    ...
    public function setDefaultText($line, $text)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_DEFAULT_TEXT, $payload, 0);
    }
    ...
    public function getDefaultText($line)
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_DEFAULT_TEXT, $payload, 28);
    ...
    public function setDefaultTextCounter($counter)
    {
        ...
        $this->sendRequest(self::FUNCTION_SET_DEFAULT_TEXT_COUNTER, $payload, 0);
    }
    ...
    public function getDefaultTextCounter()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_DEFAULT_TEXT_COUNTER, $payload, 12);
    ...
    public function callbackWrapperButtonPressed($data)
    {
        ...
        if (array_key_exists(self::CALLBACK_BUTTON_PRESSED, $this->registered_callbacks)) {
            $function = $this->registered_callbacks[self::CALLBACK_BUTTON_PRESSED];
            $user_data = $this->registered_callback_user_data[self::CALLBACK_BUTTON_PRESSED];

            call_user_func($function, $payload['button'], $user_data);
        }
    }
    ...
    public function callbackWrapperButtonReleased($data)
    {
        ...
        if (array_key_exists(self::CALLBACK_BUTTON_RELEASED, $this->registered_callbacks)) {
            $function = $this->registered_callbacks[self::CALLBACK_BUTTON_RELEASED];
            $user_data = $this->registered_callback_user_data[self::CALLBACK_BUTTON_RELEASED];
