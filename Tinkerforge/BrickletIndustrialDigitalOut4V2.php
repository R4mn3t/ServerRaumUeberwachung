 ...
 */
class BrickletIndustrialDigitalOut4V2 extends Device
{
     ...
     */
    const CALLBACK_MONOFLOP_DONE = 6;
     ...
     * @internal
     */
    const FUNCTION_SET_MONOFLOP = 4;

    /**
     * @internal
     */
    const FUNCTION_GET_MONOFLOP = 5;

    /**
     * @internal
     */
    const FUNCTION_SET_CHANNEL_LED_CONFIG = 7;

    /**
     * @internal
     */
    const FUNCTION_GET_CHANNEL_LED_CONFIG = 8;

    /**
     * @internal
     */
    const FUNCTION_SET_PWM_CONFIGURATION = 9;

    /**
     * @internal
     */
    const FUNCTION_GET_PWM_CONFIGURATION = 10;
    ...
    const DEVICE_IDENTIFIER = 2124;

    const DEVICE_DISPLAY_NAME = 'Industrial Digital Out 4 Bricklet 2.0';
     ...
     * 
     * Use BrickletIndustrialDigitalOut4V2::setSelectedValue() to change only one output channel state.
     * 
     ...
     * BrickletIndustrialDigitalOut4V2::setMonoflop() as well as the remaining time until the value flips.
     * 
    ...
    /**
     * Returns the channel LED configuration as set by BrickletIndustrialDigitalOut4V2::setChannelLEDConfig()
     * 
     * @param int $channel
     * 
     * @return int
     ...
     * function that changes a value of the channel (e.g. BrickletIndustrialDigitalOut4V2::setSelectedValue()).
     * 
    ...
    /**
     * Returns the PWM configuration as set by BrickletIndustrialDigitalOut4V2::setPWMConfiguration().
     * 
     * @param int $channel
     * 
     * @return array
    ...
    /**
     * Returns the current bootloader mode, see BrickletIndustrialDigitalOut4V2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletIndustrialDigitalOut4V2::writeFirmware(). The pointer has
     ...
     * BrickletIndustrialDigitalOut4V2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletIndustrialDigitalOut4V2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
