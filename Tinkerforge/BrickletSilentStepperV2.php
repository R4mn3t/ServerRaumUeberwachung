 ...
 */
class BrickletSilentStepperV2 extends Device
{

    /**
     * This callback is triggered when the input voltage drops below the value set by
     * BrickletSilentStepperV2::setMinimumVoltage(). The parameter is the current voltage.
     */
    const CALLBACK_UNDER_VOLTAGE = 41;

    /**
     * This callback is triggered when a position set by BrickletSilentStepperV2::setSteps() or
     * BrickletSilentStepperV2::setTargetPosition() is reached.
     * 
     * <note>
     *  Since we can't get any feedback from the stepper motor, this only works if the
     *  acceleration (see BrickletSilentStepperV2::setSpeedRamping()) is set smaller or equal to the
     *  maximum acceleration of the motor. Otherwise the motor will lag behind the
     *  control value and the callback will be triggered too early.
     * </note>
     */
    const CALLBACK_POSITION_REACHED = 42;

    /**
     * This callback is triggered periodically with the period that is set by
     * BrickletSilentStepperV2::setAllCallbackConfiguration(). The parameters are: the current velocity,
     * the current position, the remaining steps, the stack voltage, the external
     * voltage and the current consumption of the stepper motor.
     */
    const CALLBACK_ALL_DATA = 53;

    /**
     * This callback is triggered whenever the Silent Stepper Bricklet 2.0 enters a new state.
     * It returns the new state as well as the previous state.
     */
    const CALLBACK_NEW_STATE = 54;

    /**
     * This callback is triggered by GPIO changes if it is activated through BrickletSilentStepperV2::setGPIOAction().
     */
    const CALLBACK_GPIO_STATE = 55;
     ...
     * @internal
     */
    const FUNCTION_GET_INPUT_VOLTAGE = 19;
     ...
     * @internal
     */
    const FUNCTION_SET_ENABLED = 24;

    /**
     * @internal
     */
    const FUNCTION_GET_ENABLED = 25;

    /**
     * @internal
     */
    const FUNCTION_SET_BASIC_CONFIGURATION = 26;

    /**
     * @internal
     */
    const FUNCTION_GET_BASIC_CONFIGURATION = 27;

    /**
     * @internal
     */
    const FUNCTION_SET_SPREADCYCLE_CONFIGURATION = 28;

    /**
     * @internal
     */
    const FUNCTION_GET_SPREADCYCLE_CONFIGURATION = 29;

    /**
     * @internal
     */
    const FUNCTION_SET_STEALTH_CONFIGURATION = 30;

    /**
     * @internal
     */
    const FUNCTION_GET_STEALTH_CONFIGURATION = 31;

    /**
     * @internal
     */
    const FUNCTION_SET_COOLSTEP_CONFIGURATION = 32;

    /**
     * @internal
     */
    const FUNCTION_GET_COOLSTEP_CONFIGURATION = 33;

    /**
     * @internal
     */
    const FUNCTION_SET_MISC_CONFIGURATION = 34;

    /**
     * @internal
     */
    const FUNCTION_GET_MISC_CONFIGURATION = 35;

    /**
     * @internal
     */
    const FUNCTION_SET_ERROR_LED_CONFIG = 36;

    /**
     * @internal
     */
    const FUNCTION_GET_ERROR_LED_CONFIG = 37;

    /**
     * @internal
     */
    const FUNCTION_GET_DRIVER_STATUS = 38;

    /**
     * @internal
     */
    const FUNCTION_SET_MINIMUM_VOLTAGE = 39;

    /**
     * @internal
     */
    const FUNCTION_GET_MINIMUM_VOLTAGE = 40;

    /**
     * @internal
     */
    const FUNCTION_SET_TIME_BASE = 43;

    /**
     * @internal
     */
    const FUNCTION_GET_TIME_BASE = 44;

    /**
     * @internal
     */
    const FUNCTION_GET_ALL_DATA = 45;

    /**
     * @internal
     */
    const FUNCTION_SET_ALL_CALLBACK_CONFIGURATION = 46;

    /**
     * @internal
     */
    const FUNCTION_GET_ALL_DATA_CALLBACK_CONFIGURATON = 47;

    /**
     * @internal
     */
    const FUNCTION_SET_GPIO_CONFIGURATION = 48;

    /**
     * @internal
     */
    const FUNCTION_GET_GPIO_CONFIGURATION = 49;

    /**
     * @internal
     */
    const FUNCTION_SET_GPIO_ACTION = 50;

    /**
     * @internal
     */
    const FUNCTION_GET_GPIO_ACTION = 51;

    /**
     * @internal
     */
    const FUNCTION_GET_GPIO_STATE = 52;
    ...
    const DEVICE_IDENTIFIER = 2166;

    const DEVICE_DISPLAY_NAME = 'Silent Stepper Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_ALL_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_ALL_DATA_CALLBACK_CONFIGURATON] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->callback_wrappers[self::CALLBACK_ALL_DATA] = array(22, 'callbackWrapperAllData');
     ...
     * either BrickletSilentStepperV2::setTargetPosition(), BrickletSilentStepperV2::setSteps(), BrickletSilentStepperV2::driveForward() or
    ...
    /**
     * Returns the velocity as set by BrickletSilentStepperV2::setMaxVelocity().
     * 
     * 
     * @return int
     */
     ...
     * BrickletSilentStepperV2::setSpeedRamping().
     * 
     * 
     * @return array
     */
     ...
     * functions (BrickletSilentStepperV2::setTargetPosition(), BrickletSilentStepperV2::setSteps(), BrickletSilentStepperV2::driveForward() or
     * BrickletSilentStepperV2::driveBackward()). It also is possible to reset the steps to 0 or
     * set them to any other desired value with BrickletSilentStepperV2::setCurrentPosition().
     * 
     * 
     * @return int
     */
     ...
     * if the current position of the motor is 500 and BrickletSilentStepperV2::setTargetPosition() is
     * called with 1000, the stepper motor will drive 500 steps forward. It will
     * use the velocity, acceleration and deacceleration as set by
     * BrickletSilentStepperV2::setMaxVelocity() and BrickletSilentStepperV2::setSpeedRamping().
     * 
     * A call of BrickletSilentStepperV2::setTargetPosition() with the parameter *x* is equivalent to
     * a call of BrickletSilentStepperV2::setSteps() with the parameter
     * (*x* - BrickletSilentStepperV2::getCurrentPosition()).
     * 
     * @param int $position
     * 
     * @return void
    ...
    /**
     * Returns the last target position as set by BrickletSilentStepperV2::setTargetPosition().
     * 
     * 
     * @return int
     */
     ...
     * BrickletSilentStepperV2::setMaxVelocity() and BrickletSilentStepperV2::setSpeedRamping() will be used.
     * 
     * @param int $steps
     * 
     * @return void
    ...
    /**
     * Returns the last steps as set by BrickletSilentStepperV2::setSteps().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Returns the remaining steps of the last call of BrickletSilentStepperV2::setSteps().
     * For example, if BrickletSilentStepperV2::setSteps() is called with 2000 and
     * BrickletSilentStepperV2::getRemainingSteps() is called after the motor has run for 500 steps,
     * it will return 1500.
     * 
     * 
     * @return int
    ...
    /**
     * Returns the step mode as set by BrickletSilentStepperV2::setStepConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Drives the stepper motor forward until BrickletSilentStepperV2::driveBackward() or
     * BrickletSilentStepperV2::stop() is called. The velocity, acceleration and deacceleration as
     * set by BrickletSilentStepperV2::setMaxVelocity() and BrickletSilentStepperV2::setSpeedRamping() will be used.
     * 
     * 
     * @return void
     */
    ...
    /**
     * Drives the stepper motor backward until BrickletSilentStepperV2::driveForward() or
    ...
    /**
     * Returns the current as set by BrickletSilentStepperV2::setMotorCurrent().
     * 
     * 
     * @return int
     */
     ...
     *  the BrickletSilentStepperV2::setEnabled() with false function.
     * </warning>
     * 
     * @param bool $enabled
     * 
     ...
     *   (see BrickletSilentStepperV2::setMotorCurrent()).
     * 
    ...
    /**
     * Returns the configuration as set by BrickletSilentStepperV2::setBasicConfiguration().
     * 
     * 
     * @return array
     */
     ...
     *   stealth mode is disabled, even if the speed is below the threshold set in BrickletSilentStepperV2::setBasicConfiguration().
     * 
     ...
     *   (see BrickletSilentStepperV2::setBasicConfiguration()) is set to 0.
     * 
    ...
    /**
     * Returns the configuration as set by BrickletSilentStepperV2::setStealthConfiguration().
     * 
     * 
     * @return array
     */
     ...
     * 
     * * Stallguard Threshold Value: Sets the level for stall output (see BrickletSilentStepperV2::getDriverStatus()).
    ...
    /**
     * Returns the configuration as set by BrickletSilentStepperV2::setCoolstepConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the configuration as set by BrickletSilentStepperV2::setMiscConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the LED configuration as set by BrickletSilentStepperV2::setErrorLEDConfig()
     * 
     * 
     * @return int
     */
     ...
     *   ``Motor Run Current`` as set by BrickletSilentStepperV2::setBasicConfiguration(). Example: If a ``Motor Run Current``
     ...
     *   stall if autoscale is enabled (see BrickletSilentStepperV2::setStealthConfiguration()).
     * 
     * 
     * @return array
     */
    ...
    /**
     * Sets the minimum voltage, below which the BrickletSilentStepperV2::CALLBACK_UNDER_VOLTAGE callback
    ...
    /**
     * Returns the minimum voltage as set by BrickletSilentStepperV2::setMinimumVoltage().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Returns the time base as set by BrickletSilentStepperV2::setTimeBase().
     * 
     * 
     * @return int
     */
     ...
     * value (see BrickletSilentStepperV2::setBasicConfiguration()) with the ``Motor Run Current``
     * (see BrickletSilentStepperV2::getDriverStatus()). This is an internal calculation of the
     ...
     * 
     * There is also a callback for this function, see BrickletSilentStepperV2::CALLBACK_ALL_DATA callback.
     * 
     * 
     * @return array
     */
    public function getAllData()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_ALL_DATA, $payload, 22);

        $payload = unpack('v1current_velocity/V1current_position/V1remaining_steps/v1input_voltage/v1current_consumption', $data);
    ...
    /**
     * Sets the period with which the BrickletSilentStepperV2::CALLBACK_ALL_DATA callback is triggered
     ...
     * @return void
     */
    public function setAllCallbackConfiguration($period)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_ALL_CALLBACK_CONFIGURATION, $payload, 0);
    }

    /**
     * Returns the period as set by BrickletSilentStepperV2::setAllCallbackConfiguration().
     * 
     * 
     * @return int
     */
    public function getAllDataCallbackConfiguraton()
    {
        $this->checkValidity();

        $payload = '';

        $data = $this->sendRequest(self::FUNCTION_GET_ALL_DATA_CALLBACK_CONFIGURATON, $payload, 12);
     ...
     * configured as ``normal stop``. See BrickletSilentStepperV2::setGPIOAction().
     * 
     * @param int $channel
     * @param int $debounce
    ...
    /**
     * Returns the GPIO configuration for a channel as set by BrickletSilentStepperV2::setGPIOConfiguration().
     * 
     * @param int $channel
     * 
     * @return array
     ...
     * BrickletSilentStepperV2::setGPIOConfiguration().
     * 
     * @param int $channel
     * @param int $action
     * 
    ...
    /**
     * Returns the GPIO action for a channel as set by BrickletSilentStepperV2::setGPIOAction().
     * 
     * @param int $channel
     * 
     * @return int
    ...
    /**
     * Returns the current bootloader mode, see BrickletSilentStepperV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletSilentStepperV2::writeFirmware(). The pointer has
     ...
     * BrickletSilentStepperV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletSilentStepperV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
    ...
    public function callbackWrapperAllData($data)
    {
        ...
        if (array_key_exists(self::CALLBACK_ALL_DATA, $this->registered_callbacks)) {
            ...
            call_user_func($function, $payload['current_velocity'], $payload['current_position'], $payload['remaining_steps'], $payload['input_voltage'], $payload['current_consumption'], $user_data);
        }
    }
