 ...
 */
class BrickletRotaryEncoderV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletRotaryEncoderV2::setCountCallbackConfiguration().
     * 
     * The parameter is the same as BrickletRotaryEncoderV2::getCount().
     */
    const CALLBACK_COUNT = 4;

    /**
     * This callback is triggered when the button is pressed.
     */
    const CALLBACK_PRESSED = 6;

    /**
     * This callback is triggered when the button is released.
     */
    const CALLBACK_RELEASED = 7;
     ...
     * @internal
     */
    const FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_COUNT_CALLBACK_CONFIGURATION = 3;

    /**
     * @internal
     */
    const FUNCTION_IS_PRESSED = 5;
    ...
    const DEVICE_IDENTIFIER = 294;

    const DEVICE_DISPLAY_NAME = 'Rotary Encoder Bricklet 2.0';
     ...
     * BrickletRotaryEncoderV2::CALLBACK_COUNT callback. You can set the callback configuration
     * with BrickletRotaryEncoderV2::setCountCallbackConfiguration().
     * 
     * @param bool $reset
     * 
     * @return int
    ...
    /**
     * The period is the period with which the BrickletRotaryEncoderV2::CALLBACK_COUNT callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletRotaryEncoderV2::CALLBACK_COUNT callback.
     * 
    ...
    /**
     * Returns the callback configuration as set by BrickletRotaryEncoderV2::setCountCallbackConfiguration().
     * 
     * 
     * @return array
     */
     ...
     * 
     * It is recommended to use the BrickletRotaryEncoderV2::CALLBACK_PRESSED and BrickletRotaryEncoderV2::CALLBACK_RELEASED callbacks
    ...
    /**
     * Returns the current bootloader mode, see BrickletRotaryEncoderV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletRotaryEncoderV2::writeFirmware(). The pointer has
     ...
     * BrickletRotaryEncoderV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletRotaryEncoderV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
