 ...
 */
class BrickletMotorizedLinearPoti extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletMotorizedLinearPoti::setPositionCallbackConfiguration().
     * 
     * The parameter is the same as BrickletMotorizedLinearPoti::getPosition().
     */
    const CALLBACK_POSITION = 4;

    /**
     * This callback is triggered if a new position as set by
     * BrickletMotorizedLinearPoti::setMotorPosition() is reached.
     * 
     * The parameter is the current position.
     */
    const CALLBACK_POSITION_REACHED = 10;
     ...
     * @internal
     */
    const FUNCTION_SET_POSITION_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_POSITION_CALLBACK_CONFIGURATION = 3;

    /**
     * @internal
     */
    const FUNCTION_SET_MOTOR_POSITION = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_MOTOR_POSITION = 6;

    /**
     * @internal
     */
    const FUNCTION_CALIBRATE = 7;

    /**
     * @internal
     */
    const FUNCTION_SET_POSITION_REACHED_CALLBACK_CONFIGURATION = 8;

    /**
     * @internal
     */
    const FUNCTION_GET_POSITION_REACHED_CALLBACK_CONFIGURATION = 9;
    ...
    const DRIVE_MODE_FAST = 0;
    const DRIVE_MODE_SMOOTH = 1;
    ...
    const DEVICE_IDENTIFIER = 267;

    const DEVICE_DISPLAY_NAME = 'Motorized Linear Poti Bricklet';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_MOTOR_POSITION] = self::RESPONSE_EXPECTED_FALSE;
        $this->response_expected[self::FUNCTION_GET_MOTOR_POSITION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
     ...
     * BrickletMotorizedLinearPoti::CALLBACK_POSITION callback. You can set the callback configuration
     * with BrickletMotorizedLinearPoti::setPositionCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletMotorizedLinearPoti::CALLBACK_POSITION callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletMotorizedLinearPoti::CALLBACK_POSITION callback.
     * 
     ...
     * @return void
     */
    public function setPositionCallbackConfiguration($period, $value_has_to_change, $option, $min, $max)
    {
        $this->checkValidity();
    ...
    /**
     * Returns the callback configuration as set by BrickletMotorizedLinearPoti::setPositionCallbackConfiguration().
     * 
     * 
     * @return array
     */
    public function getPositionCallbackConfiguration()
    {
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_POSITION_CALLBACK_CONFIGURATION, $payload, 18);
     ...
     * 
     * @param int $position
     * @param int $drive_mode
     * @param bool $hold_position
     * 
     * @return void
     */
    public function setMotorPosition($position, $drive_mode, $hold_position)
    {
        $this->checkValidity();

        $payload = '';
        $payload .= pack('v', $position);
        $payload .= pack('C', $drive_mode);
        $payload .= pack('C', intval((bool)$hold_position));

        $this->sendRequest(self::FUNCTION_SET_MOTOR_POSITION, $payload, 0);
    }

    /**
     * Returns the last motor position as set by BrickletMotorizedLinearPoti::setMotorPosition(). This is not
     * the current position (use BrickletMotorizedLinearPoti::getPosition() to get the current position). This
     ...
     * @return array
     */
    public function getMotorPosition()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_MOTOR_POSITION, $payload, 13);

        $payload = unpack('v1position/C1drive_mode/C1hold_position/C1position_reached', $data);

        $ret['position'] = $payload['position'];
        $ret['drive_mode'] = $payload['drive_mode'];
        $ret['hold_position'] = (bool)$payload['hold_position'];
        $ret['position_reached'] = (bool)$payload['position_reached'];
    ...
    /**
     * Enables/Disables BrickletMotorizedLinearPoti::CALLBACK_POSITION_REACHED callback.
     * 
     * @param bool $enabled
     * 
     * @return void
     */
    public function setPositionReachedCallbackConfiguration($enabled)
    {
        $this->checkValidity();
    ...
    /**
     * Returns the BrickletMotorizedLinearPoti::CALLBACK_POSITION_REACHED callback configuration
     * as set by BrickletMotorizedLinearPoti::setPositionReachedCallbackConfiguration().
     * 
     * 
     * @return bool
     */
    public function getPositionReachedCallbackConfiguration()
    {
        $this->checkValidity();
    ...
    /**
     * Returns the current bootloader mode, see BrickletMotorizedLinearPoti::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletMotorizedLinearPoti::writeFirmware(). The pointer has
     ...
     * BrickletMotorizedLinearPoti::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletMotorizedLinearPoti::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
