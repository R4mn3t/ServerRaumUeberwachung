 ...
 */
class BrickletRotaryPotiV2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletRotaryPotiV2::setPositionCallbackConfiguration().
     * 
     * The parameter is the same as BrickletRotaryPotiV2::getPosition().
     */
    ...
    const DEVICE_IDENTIFIER = 2140;

    const DEVICE_DISPLAY_NAME = 'Rotary Poti Bricklet 2.0';
     ...
     * BrickletRotaryPotiV2::CALLBACK_POSITION callback. You can set the callback configuration
     * with BrickletRotaryPotiV2::setPositionCallbackConfiguration().
     * 
     * 
     * @return int
     */
    ...
    /**
     * The period is the period with which the BrickletRotaryPotiV2::CALLBACK_POSITION callback is triggered
     ...
     * 
     * The `option`-parameter together with min/max sets a threshold for the BrickletRotaryPotiV2::CALLBACK_POSITION callback.
     * 
    ...
    /**
     * Returns the callback configuration as set by BrickletRotaryPotiV2::setPositionCallbackConfiguration().
     * 
     * 
     * @return array
     */
    ...
    /**
     * Returns the current bootloader mode, see BrickletRotaryPotiV2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletRotaryPotiV2::writeFirmware(). The pointer has
     ...
     * BrickletRotaryPotiV2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletRotaryPotiV2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
