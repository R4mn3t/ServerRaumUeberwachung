...
class BrickletCurrent12 extends Device
{
     ...
     * sensor.
     * 
     * The BrickletCurrent12::CALLBACK_CURRENT callback is only triggered if the current has changed since
     * the last triggering.
     */
     ...
     * of the sensor.
     * 
     * The BrickletCurrent12::CALLBACK_ANALOG_VALUE callback is only triggered if the current has changed since the
     * last triggering.
     */
    ...
    const DEVICE_DISPLAY_NAME = 'Current12 Bricklet';
     ...
     * BrickletCurrent12::CALLBACK_CURRENT callback and set the period with
     ...
     * BrickletCurrent12::CALLBACK_ANALOG_VALUE callback and set the period with
    ...
    /**
     * Sets the period with which the BrickletCurrent12::CALLBACK_CURRENT callback is triggered
    ...
    /**
     * Sets the period with which the BrickletCurrent12::CALLBACK_ANALOG_VALUE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * The BrickletCurrent12::CALLBACK_ANALOG_VALUE callback is only triggered if the analog value has
