 ...
 */
class BrickletIndustrialDigitalIn4V2 extends Device
{

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletIndustrialDigitalIn4V2::setValueCallbackConfiguration().
     * 
     ...
     */
    const CALLBACK_VALUE = 11;

    /**
     * This callback is triggered periodically according to the configuration set by
     * BrickletIndustrialDigitalIn4V2::setAllValueCallbackConfiguration().
     * 
     * The parameters are the same as BrickletIndustrialDigitalIn4V2::getValue(). Additional the
     * `changed` parameter is true if the value has changed since
     * the last callback.
     */
    const CALLBACK_ALL_VALUE = 12;
     ...
     * @internal
     */
    const FUNCTION_SET_VALUE_CALLBACK_CONFIGURATION = 2;

    /**
     * @internal
     */
    const FUNCTION_GET_VALUE_CALLBACK_CONFIGURATION = 3;

    /**
     * @internal
     */
    const FUNCTION_SET_ALL_VALUE_CALLBACK_CONFIGURATION = 4;

    /**
     * @internal
     */
    const FUNCTION_GET_ALL_VALUE_CALLBACK_CONFIGURATION = 5;

    /**
     * @internal
     */
    const FUNCTION_GET_EDGE_COUNT = 6;

    /**
     * @internal
     */
    const FUNCTION_SET_EDGE_COUNT_CONFIGURATION = 7;

    /**
     * @internal
     */
    const FUNCTION_GET_EDGE_COUNT_CONFIGURATION = 8;
    ...
    const DEVICE_IDENTIFIER = 2100;

    const DEVICE_DISPLAY_NAME = 'Industrial Digital In 4 Bricklet 2.0';
    ...
    public function __construct($uid, $ipcon)
    {
        ...
        $this->response_expected[self::FUNCTION_SET_VALUE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_VALUE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        $this->response_expected[self::FUNCTION_SET_ALL_VALUE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_TRUE;
        $this->response_expected[self::FUNCTION_GET_ALL_VALUE_CALLBACK_CONFIGURATION] = self::RESPONSE_EXPECTED_ALWAYS_TRUE;
        ...
        $this->callback_wrappers[self::CALLBACK_VALUE] = array(11, 'callbackWrapperValue');
        $this->callback_wrappers[self::CALLBACK_ALL_VALUE] = array(10, 'callbackWrapperAllValue');
     ...
     * 
     * The period is the period with which the BrickletIndustrialDigitalIn4V2::CALLBACK_VALUE
     ...
     * @return void
     */
    public function setValueCallbackConfiguration($channel, $period, $value_has_to_change)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_VALUE_CALLBACK_CONFIGURATION, $payload, 0);
    }
     ...
     * @return array
     */
    public function getValueCallbackConfiguration($channel)
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_VALUE_CALLBACK_CONFIGURATION, $payload, 13);
    ...
    /**
     * The period is the period with which the BrickletIndustrialDigitalIn4V2::CALLBACK_ALL_VALUE
     * callback is triggered periodically. A value of 0 turns the callback off.
     * 
     * If the `value has to change`-parameter is set to true, the callback is only
     * triggered after the value has changed. If the value didn't change within the
     ...
     * @return void
     */
    public function setAllValueCallbackConfiguration($period, $value_has_to_change)
    {
        $this->checkValidity();
        ...
        $this->sendRequest(self::FUNCTION_SET_ALL_VALUE_CALLBACK_CONFIGURATION, $payload, 0);
    }
     ...
     * @return array
     */
    public function getAllValueCallbackConfiguration()
    {
        $this->checkValidity();
        ...
        $data = $this->sendRequest(self::FUNCTION_GET_ALL_VALUE_CALLBACK_CONFIGURATION, $payload, 13);
     ...
     * configure the edges that are counted with BrickletIndustrialDigitalIn4V2::setEdgeCountConfiguration().
     * 
     ...
     * BrickletIndustrialDigitalIn4V2::setEdgeCountConfiguration().
     * 
     * @param int $channel
     * 
     * @return array
    ...
    /**
     * Returns the channel LED configuration as set by BrickletIndustrialDigitalIn4V2::setChannelLEDConfig()
     * 
     * @param int $channel
     * 
     * @return int
    ...
    /**
     * Returns the current bootloader mode, see BrickletIndustrialDigitalIn4V2::setBootloaderMode().
     * 
     * 
     * @return int
     */
    ...
    /**
     * Sets the firmware pointer for BrickletIndustrialDigitalIn4V2::writeFirmware(). The pointer has
     ...
     * BrickletIndustrialDigitalIn4V2::setWriteFirmwarePointer() before. The firmware is written
    ...
    /**
     * Returns the configuration as set by BrickletIndustrialDigitalIn4V2::setStatusLEDConfig()
     * 
     * 
     * @return int
     */
     ...
     * @param string $data
     */
    public function callbackWrapperValue($data)
    {
        $payload = unpack('C1channel/C1changed/C1value', $data);
        $payload['changed'] = (bool)$payload['changed'];
        $payload['value'] = (bool)$payload['value'];

        if (array_key_exists(self::CALLBACK_VALUE, $this->registered_callbacks)) {
            $function = $this->registered_callbacks[self::CALLBACK_VALUE];
            $user_data = $this->registered_callback_user_data[self::CALLBACK_VALUE];
     ...
     * @param string $data
     */
    public function callbackWrapperAllValue($data)
    {
        ...
        if (array_key_exists(self::CALLBACK_ALL_VALUE, $this->registered_callbacks)) {
            $function = $this->registered_callbacks[self::CALLBACK_ALL_VALUE];
            $user_data = $this->registered_callback_user_data[self::CALLBACK_ALL_VALUE];
